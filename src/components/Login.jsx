...
function Login(){
    ...
    return(
        ...
        <div className="detail-inputs" style = {mystyleFour} >
            <h1 style=  {mystylefive}>Sign In</h1>
            <input style=  {mystylefive} type="E-mail" onChange={handleChange} value={stateInit.email} name ="email" placeholder="Email Address"></input><br></br>
            <input style=  {mystylefive} type="password" onChange={handleChange} value={stateInit.password} name ="password"  placeholder="Password"></input><br></br>
            <p style=  {mystylefive}>By signing in, I agree to the Vrbo <a href = "https://www.vrbo.com/legal/terms-and-conditions" target="_blank">Terms and <br></br>
