...
function Footer() {
  return (
    <div>
      ...
      <span>&#169; 2022 Vrbo, an expedia group company.All rights reserved</span>
      <p><a href="" target="_blank">Terms and Conditions</a> | <a href="" target="_blank">Privacy Policy</a> | <a href="" target="_blank">Do Not Sell My Personal Information</a></p>
    <div>
    <h3>Get special offers, travel inspiration, and more from Vrbo</h3>
    <input placeholder = "Email Address"  type="email"></input><button>Subscribe</button>

    <h3>Get the Vrbo mobile app</h3>
    <input placeholder="Your mobile phone number" type="telephone"></input><button>Send</button>
    ...
    <a href = "" target = '_blank'>Pintrest</a>
